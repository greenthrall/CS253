...
# Original Answer
#    v_parsed = minidom.parseString(xml)
#    v_xmltag = v_parsed.getElementsByTagName('gml:coordinates')[0].toxml()
#    v_xmldata = v_xmltag.replace('<gml:coordinates>','').replace('</gml:coordinates>','')
#    if v_xmldata:
#        return v_xmldata.split(',')[1], v_xmldata.split(',')[0]
